...
export default async function BasketballPage() {
    ...
    const mockStandings = [
        { rank: 1, team: 'Times College', played: 14, won: 12, draw: 0, lost: 2, points: 24, logo_url: 'https://via.placeholder.com/50' },
        { rank: 2, team: 'Golden Gate', played: 14, won: 10, draw: 0, lost: 4, points: 20, logo_url: 'https://via.placeholder.com/50' },
        { rank: 3, team: 'Tribhuvan Army', played: 14, won: 9, draw: 0, lost: 5, points: 18, logo_url: 'https://via.placeholder.com/50' },
        { rank: 4, team: 'Royal Basketball', played: 14, won: 8, draw: 0, lost: 6, points: 16, logo_url: 'https://via.placeholder.com/50' },
        { rank: 5, team: 'Kirtipur Basketball', played: 14, won: 6, draw: 0, lost: 8, points: 12, logo_url: 'https://via.placeholder.com/50' },
    ];

    const links = [
        { label: 'Home', href: '/basketball' },
        { label: 'Scores', href: '/basketball/scores' },
        { label: 'Standings', href: '/basketball/standings' },
        { label: 'Teams', href: '/basketball/teams' },
    ];

    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            <SportHeader sport="Basketball" links={links} />
            ...
            <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <StandingsWidget title="Nepal Basketball League" standings={mockStandings} />
